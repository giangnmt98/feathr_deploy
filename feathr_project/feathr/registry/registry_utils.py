...
from feathr.definition.source import HdfsSource, JdbcSource, Source, SnowflakeSource, MongoDbSource
...
def source_to_def(source: Source) -> dict:
    ...
    elif isinstance(source, MongoDbSource):
        ret = {
            "name": source.name,
            "type": "mongodb",
            "url": source.url,
